 ...
 */
public abstract class Spark33SpecificParquetRecordReaderBase<T> extends RecordReader<Void, T> {
  protected Path file;
  ...
  public void initialize(InputSplit inputSplit, TaskAttemptContext taskAttemptContext, Option<ParquetMetadata> fileFooter)
      throws IOException, InterruptedException {
